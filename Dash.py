...
# Update the app layout to include the filtered data table
...
@app.callback(Output('filtered-data-table', 'children'),
              [Input('site-dropdown', 'value'),
               Input('payload-slider', 'value')])
def update_filtered_table(launch_site, payload_range):
